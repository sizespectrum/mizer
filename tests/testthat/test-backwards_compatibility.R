...
test_that("MizerParams() works as in version 1", {
    ...
    expect_known_value(getPredRate(params), "values/set_multispecies_model_pred_rate")
    expect_known_value(getEncounter(params), "values/set_multispecies_model_encounter")
...
test_that("set_trait_model() works as in version 1", {
    ...
    expect_known_value(getPredRate(params), "values/set_trait_model_pred_rate")
    expect_known_value(getEncounter(params), "values/set_trait_encounter")
    sim <- project(params, t_max = 0.1, t_save = 0.1)
...
test_that("set_community_model() works as in version 1", {
    ...
    expect_known_value(getPredRate(params), "values/set_community_model_pred_rate")
    expect_known_value(getEncounter(params), "values/set_community_encounter")
    sim <- project(params, t_max = 0.1, t_save = 0.1)

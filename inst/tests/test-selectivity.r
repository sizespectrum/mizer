...
test_that("knife-edge selectivity function is working properly",{
    ...
    species_params_gears$knife_is_min <- TRUE
    species_params_gears$knife_edge_size[species_params_gears$gear == "industrial"] <- 500
    species_params_gears$knife_is_min[species_params_gears$gear == "industrial"] <- FALSE

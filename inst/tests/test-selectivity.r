...
test_that("knife-edge selectivity function is working properly",{
    ...
    species_params_gears$w_limit <- 1000
    species_params_gears$is_min <- TRUE
    species_params_gears$w_limit[species_params_gears$gear == "industrial"] <- 500
    species_params_gears$is_min[species_params_gears$gear == "industrial"] <- FALSE

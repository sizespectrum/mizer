...
|---|---|---|
| [`plotBiomass(sim)`](../reference/plotBiomass.html) | `species`, `total`, `start_time`, `end_time`, `log` | total biomass per species |
| [`plotYield(sim)`](../reference/plotYield.html) | `species`, `total`, `log` | total yield per species |
...
| [`plotFeedingLevel(sim)`](../reference/plotFeedingLevel.html) | `time_range`, `species`, `highlight` | feeding level (0–1) at size |
| [`plotPredMort(sim)`](../reference/plotPredMort.html) | `time_range`, `species`, `highlight` | predation mortality at size |
| [`plotFMort(sim)`](../reference/plotFMort.html) | `time_range`, `species`, `highlight` | fishing mortality at size |
| [`plotGrowthCurves(sim)`](../reference/plotGrowthCurves.html) | `species`, `max_age`, `percentage`, `species_panel` | size at age |
| [`plotDiet(params)`](../reference/plotDiet.html) | `species` | diet composition at size |

...
The website creation is performed by a slight modification of the 
...
## GitHub pages
The website is hosted with [GitHub Pages](https://pages.github.com/). In the
...
R Markdown source file. For example putting the line
```

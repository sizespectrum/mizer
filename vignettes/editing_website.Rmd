...
5. The index.md file will be converted to `docs/index.html`.
...
Note that the github site itself (as opposed to GitHub Pages) does not support
embedded videos. That is why we have the website homepage in index.md and
the github homepage in README.md.
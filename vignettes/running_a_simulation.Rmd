...
The length of the simulation is determined by the `t_max` argument (see [the section on time arguments](multispecies_model.html#sec:time_arguments)).
...
The results of the simulations will not be explored in detail. We will leave that for [the section on summary methods for MizerSim objects.](exploring_the_simulation_results.html#).

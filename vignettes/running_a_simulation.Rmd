...
of the species and the plankton spectrum need to be specified. Default values
...
`initialNPlankton()`. `initialN()` should be set to a matrix (with dimensions
species x size) that contains the initial abundances of each species at size
(the sizes must match those in the species size spectrum). `initialNPlankton` to

...
Considering the other model parameters, we will use default values for all of the other parameters apart from `kappa`, the carrying capacity of the plankton spectrum (see Section~\@ref(sec:parameters)).

...
For quick reference while working we also provide topic-based cheat sheets, one
for each stage of the workflow:

-   [Model setup](https://sizespectrum.org/mizer/articles/cheatsheet-model-setup.html)
-   [Steady state and calibration](https://sizespectrum.org/mizer/articles/cheatsheet-calibration.html)
-   [Changing model parameters](https://sizespectrum.org/mizer/articles/cheatsheet-changing-parameters.html)
-   [Fishing](https://sizespectrum.org/mizer/articles/cheatsheet-fishing.html)
-   [Running simulations](https://sizespectrum.org/mizer/articles/cheatsheet-running-simulations.html)
-   [Analysis and plotting](https://sizespectrum.org/mizer/articles/cheatsheet-analysis-and-plotting.html)
-   [Extending mizer](https://sizespectrum.org/mizer/articles/cheatsheet-extending-mizer.html)
...
the strength of density dependence in reproduction. `setBevertonHolt()` sets it

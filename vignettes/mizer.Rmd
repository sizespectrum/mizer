...
We also provide topic-based guides, one for each stage of the workflow. Each
starts from scratch, so you can read one without having read the others:

-   [Understanding size-spectrum dynamics](https://sizespectrum.org/mizer/articles/guide-understand-size-spectrum-dynamics.html)
-   [Building a mizer model](https://sizespectrum.org/mizer/articles/guide-build-model.html)
-   [Reaching steady state and calibrating](https://sizespectrum.org/mizer/articles/guide-calibrate-model.html)
-   [Changing model parameters](https://sizespectrum.org/mizer/articles/guide-change-parameters.html)
-   [Setting up fishing](https://sizespectrum.org/mizer/articles/guide-set-up-fishing.html)
-   [Running a simulation](https://sizespectrum.org/mizer/articles/guide-run-simulation.html)
-   [Analysing and plotting results](https://sizespectrum.org/mizer/articles/guide-analyse-and-plot.html)
-   [Extending mizer](https://sizespectrum.org/mizer/articles/guide-extend-mizer.html)
-   [Using mizer extension packages](https://sizespectrum.org/mizer/articles/guide-use-extension-packages.html)
...
A freshly built model has only a rough spectrum. `steady()` runs the
size-spectrum dynamics, holding reproduction and the resource fixed, until the
community settles onto a steady state.
...
**re-running `steady()` after every adjustment** because each change pushes the

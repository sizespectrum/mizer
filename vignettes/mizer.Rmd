...
you calibrate the model to data. We have suppressed them here to keep the output
short. Calibrating such a model to observed biomasses and yields is demonstrated
in the [worked example](#a-worked-example-the-celtic-sea) below.
...
maximum size `w_max` it carries a few life-history parameters and, crucially,

...
is a left Riemann sum for the available energy from eating background
resources. These terms are calculated in a way that exploits R's vectorized
...
### Spectral Integration For available energy {#subsec:spec energy}

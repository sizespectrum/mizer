...
mizer is a package for the R open-source statistical programming language. 
...
You can install R on your computer by following the instructions

If you need to [install R](https://cran.r-project.org/). Simply install 

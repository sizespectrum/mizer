...
the product of a gear's **selectivity** at size, its **catchability** for a
species, and its **effort**. Selectivity and catchability are configured through
the [`gear_params`](../reference/gear_params.html) data frame; effort is set at
run time. All setter functions return a new `MizerParams` — reassign the result.
...
| Function | Use |
|---|---|
| [`getInitialEffort(params)`](../reference/setFishing.html) | read baseline effort (a named vector) |

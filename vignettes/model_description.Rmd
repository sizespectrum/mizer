...
Besides the fish spectrum there is also a resource spectrum $NResource(w)$,
...
\end{equation}
Here $r_p(w)$ is the resource regeneration rate and $c_p(w)$ is the carrying
...
described in the help page for `setResource()`. The mortality $\mu_p(w)$ is
...
Three important density-dependent effects that in usual fisheries models are 

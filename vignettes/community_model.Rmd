...
```{r label=print_plot_comm_m2, echo=FALSE, warning=FALSE, fig.height=4,fig.cap="Predation mortality without fishing in the community model (note the log scales for both axes)."}
...
```{r label=print_plot_comm_fmort, echo=FALSE, fig.height=9,fig.cap="Summary plot for the community model when fishing with knife-edge selectivity at size = 1000 g."}
plot(sim1)
```
 {#fig:plot_comm_fmort}

...
```{r label=help_newCommunityParams, eval=FALSE}
?newCommunityParams
```
...
params <- newCommunityParams(z0 = 0.1, f0 = 0.7, alpha = 0.2, recruitment = 4e7)
```
...
params_knife <- newCommunityParams(z0 = 0.1, recruitment = 4e7,
...
params_sigma1 <- newCommunityParams(z0 = 0.1,

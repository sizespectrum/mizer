...
The arguments that you should pay attention to are: `z0` (the level of background mortality), `alpha` (the assimilation efficiency of the community), `f0` (the average feeding level of the community which is used to calculate $\gamma,$ as described in [the equation for gamma](#eq:gamma) and `recruitment` (the level of constant recruitment).

...
If you want to contribute some of you code to the official mizer code at
...
could simply follow the procedure described in the
...
your code changes, as is explained in the "[Creating a
branch](working_with_git.html#creating-a-branch)" section of the "Working with
...
requests, as explained in the "[Working with git and
GitHub](working_with_git.html)" tutorial.

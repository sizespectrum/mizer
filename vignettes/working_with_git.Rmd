...
<center>
![New branch button](images/new_branch_button.png){width=30%}
</center>
...
<center>
![Markdown outline in RStudio](images/outline.png){width=30%}
</center>
...
<center>
![Commit button in Git tab](images/commit_button.png){width=40%}
</center>

This will pop up a screen like the following:
<center>
![Commit dialog box](images/commit.png){width=70%}
</center>
...
<center>
![Recently pushed branches on GitHub](images/recently_pushed.png){width=80%}
</center>

...
sim_d_low <- run_with_diffusion(params_pulse, diff_coeff = 0.01, diff_exp = diff_exp)
sim_d_high <- run_with_diffusion(params_pulse, diff_coeff = 0.1, diff_exp = , diff_exp)
```

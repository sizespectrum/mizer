...
<<plot_trait_ins3, eval=FALSE>>=
plotBiomass(sim_trait)
@

\begin{figure}
<<label=print_plot_trait_ins2, echo=FALSE, fig.height=4, fig.keep='last'>>=
<<plot_trait_ins3>>
@

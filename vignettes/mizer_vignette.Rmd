...
% width = x, in the ```{r } affects the R plot (i.e. label size) but not the actual image width
...
\author{}
\date{\pkg{mizer} version \Sexpr{packageDescription("mizer")[["Version"]]}, 30 April 2018. }
\maketitle

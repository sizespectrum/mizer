...
\begin{itemize}
 ...
 \item Scale invariance also requires that the exponent of the plankton 
...
\item (Equation~\@ref(eq:nb)) The plankton spectrum extends from the smallest weight at which an explicitly 
...
$w$ approaches $\min\{w_{*i}\}$ from below, the carrying capacity of the plankton declines to zero.  
...
%We also arrange things so that as $w$ approaches $\min\{w_{*i}\}$ from below, the carrying capacity of the plankton declines to zero.

...
In the plot above there are ten species; $W$ is taken over a range 10 g
to 1000 g,
...
* (Equation~\@ref(eq:psi)) We assume that the proportion of energy allocated to 
...
* (Equation~\@ref(eq:R))  A stock-recruitment relationship is not 
...
* (Equation~\@ref(eq:mu_b)) Beyond the upper limit of body weight. 
 The total mortality
...
* (Equation~\@ref(eq:nb)) The plankton spectrum extends from the smallest weight at which an explicitly 

...
object. If the model needs an extension package, these are the only safe
way to persist it — a bare
[`readRDS()`](https://rdrr.io/r/base/readRDS.html) silently strips the
extension class. See the [guide to using mizer extension

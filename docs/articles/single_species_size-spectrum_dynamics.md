...
```
    ...
    ##  Target species   100 25.11886 30  3  0 3.896875
    ## With 26 other parameters: w_min, w_max, w_min_idx, gamma, f0, fc, beta, sigma, alpha, erepro, n, p, w_repro_max, is_background, a, b, interaction_resource, pred_kernel_type, k, d, E_ext, D_ext, q, w_mat25, m, R_max
...
rather than with
[`species_params()`](https://sizespectrum.org/mizer/reference/species_params.md).
Both would work and trigger a recalculation of any other parameters that
are derived from the changed parameters. The difference is that
[`given_species_params()`](https://sizespectrum.org/mizer/reference/species_params.md)
is particularly helpful during interactive use because it issues
warnings if you try to change a parameter whose effect is overridden by
another parameter.
...
```
    ...
    ## An object of class "gear_params" containing 1 gear-species pairs for 1 gear:
    ##             gear        species   sel_func catchability
    ##  knife_edge_gear Target species knife_edge            1

...
twitter to @[mizer_model](https://x.com/mizer_model). We love to hear
from you.
...
Mizer is compatible with R versions 3.1 and later. You can install R on
...
![](mizer_vignette_files/figure-html/unnamed-chunk-8-1.png)

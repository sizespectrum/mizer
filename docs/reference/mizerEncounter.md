...
projections. Extension packages can add methods for their extension
classes and call [`NextMethod()`](https://rdrr.io/r/base/UseMethod.html)
to compose encounter-rate changes. The `MizerParams` method contains the

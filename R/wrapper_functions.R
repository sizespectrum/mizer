...
#'   - n.
#' @param r_pp Growth rate of the background resource spectrum. Default value is 10.
...
#' @param r_pp Growth rate of the background resource spectrum. Default value is 4.
...
#' @param r_pp Growth rate of the background resource spectrum. Default value is 0.1.
#' @param kappa Coefficient in abundance power law. Default value is
#'   0.005.
#' @param alpha The assimilation efficiency of the community. The default value
#'   is 0.4.
